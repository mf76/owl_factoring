...
$subject = "アウル経済の請求書買い取り_LPからの問い合わせ";
...
$require = array('買取希望の請求書の額面', 'Email');
...
$refrom_name = "「アウル経済の請求書買い取り」";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "「アウル経済の請求書買い取り」へのお問い合わせを受け付けました";
...
この度は「アウル経済の請求書買い取り」無料お見積りをご利用いただき、誠にありがとうございます。
内容の確認が取れ次第、担当の者より入力いただいた連絡先宛にご連絡させていただきます。
今しばらくお待ち下さいませ。

また、本メールはお客様の控えとなりますので大切に保管していただきますようお願い致します。
			...
			<div class="columns medium-12">
				...
				<div id="formWrap">
					<?php if ($empty_flag == 1) { ?>
						...
						<?php echo $errm; ?><br /><br /><input class="button small" value=" 前画面に戻る " onClick="history.back()">

					<?php } else { ?>
						<main id="mainContact">
							<div class="top">
								<h1 class="greenH2">確認画面</h1>
							</div>
							<div class="widthKeeper">
								<p class="fp" align="center">以下の内容でお間違いなければ、<br>「送信する」ボタンを押してください。</p><br>
								<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
									...
									<p align="center"><input type="hidden" name="mail_set" value="confirm_submit">
										...
										<br>
										<input id="mail_btn_submit" type="submit" value="送信する">
										<input id="mail_btn_prev" onClick="history.back()" value="前に戻る"></p>
...
?>
	...
	<head>
		...
		<title>送信完了</title>
		<meta name="description" content="お問い合わせの送信を完了しました。">
		...
		<link rel="stylesheet" href="https://use.typekit.net/xqq0yut.css">
